...
const mockChatResponses = {
  academic: [
    "I understand academic stress can be overwhelming. What specifically is causing you the most pressure right now?",
    "It sounds like you're dealing with a lot. Have you tried breaking your tasks into smaller, manageable chunks?",
    "Remember, it's okay to ask for help. Your professors and academic advisors are there to support you."
  ],
  anxiety: [
    "Anxiety can feel really intense. Can you tell me what triggers these feelings for you?",
    "Deep breathing can help in the moment. Try inhaling for 4 counts, holding for 4, and exhaling for 6.",
    "You're not alone in feeling this way. Many students experience anxiety, and it's completely valid."
  ],
  relationships: [
    "Relationships can be complicated. What's been on your mind about this situation?",
    "It's important to communicate openly and honestly. Have you been able to share your feelings?",
    "Healthy boundaries are crucial in any relationship. How do you feel about setting some?"
  ],
  default: [
    ...
    "I hear you. Your feelings are completely valid. What would help you feel better right now?"
  ]
};

const generateMockResponse = (topic: string, userMessage: string): string => {
  const responses = mockChatResponses[topic as keyof typeof mockChatResponses] || mockChatResponses.default;
...
export function BestieChat({ 
  ...
  const handleSendMessage = async () => {
    ...
    if (sessionId) {
      console.log(`Mock: Message sent to session ${sessionId}: ${messageContent}`);
    }
    ...
    setTimeout(async () => {
      ...
      // Mock bestie response logging
      if (sessionId) {
        console.log(`Mock: Bestie response sent to session ${sessionId}: ${bestieResponse.content}`);
      }
