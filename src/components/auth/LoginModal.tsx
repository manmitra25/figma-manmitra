...
export function LoginModal({ isOpen, onClose, language, userRole = 'student' }: LoginModalProps) {
  ...
  const handleSocialLogin = async (provider: 'google' | 'facebook' | 'github') => {
    ...
    try {
      // Note: Social login setup required in backend configuration
      // For demo purposes, showing the method
      alert(`Social login with ${provider} requires backend configuration. Please use email/password for now.`);
    } catch (error) {
